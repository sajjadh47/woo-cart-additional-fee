...
Just after installing Cart Additional Fee For WooCommerce plugin, Go to WooCommerce > Settings > Cart Additional Fee tab.
...
= 2.0.0 =
- Checked for compatibility for wp 6.7
= 1.0.4 =
- Checked for compatibility for wp 6.6
= 1.0.3 =
- Checked for compatibility for wp 6.3
= 1.0.2 =
