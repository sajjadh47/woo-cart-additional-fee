 ...
 * @since    2.0.0
 */
function activate_woo_cart_additional_fee()
{
	require_once WOO_CART_ADDITIONAL_FEE_PLUGIN_PATH . 'includes/class-plugin-activator.php';
	
	Woo_Cart_Additional_Fee_Activator::activate();
}

register_activation_hook( __FILE__, 'activate_woo_cart_additional_fee' );
 ...
 * @since    2.0.0
 */
function deactivate_woo_cart_additional_fee()
{
	require_once WOO_CART_ADDITIONAL_FEE_PLUGIN_PATH . 'includes/class-plugin-deactivator.php';
	
	Woo_Cart_Additional_Fee_Deactivator::deactivate();
}

register_deactivation_hook( __FILE__, 'deactivate_woo_cart_additional_fee' );
 ...
 * @since    2.0.0
 */
require WOO_CART_ADDITIONAL_FEE_PLUGIN_PATH . 'includes/class-plugin.php';
